...
// instructionTemplate contains the rule template for the instruction phase
const instructionTemplate = `---
description: 
globs: 
alwaysApply: true
---
**You MUST follow these rules when the active phase, read from @session.txt, is "Instruction".**
...
The primary artifact of this phase is [instruction.md](mdc:.i3/{{feature}}/instruction.txt). It MUST provide a clear technical roadmap, structured as follows:
...
*   **DO NOT Solve Problems Outside the Ideation Scope**: Strictly adhere to the problem space defined in [ideation.md](mdc:.i3/{{feature}}/ideation.txt).
...
*   **Primary Sources:**
    *   [ideation.md](mdc:.i3/{{feature}}/ideation.txt): Critical - Contains the defined problem space, requirements, and scope. This is the foundation for your technical solution.
...
1.  **Review Problem Space Thoroughly**: Start by carefully examining [ideation.md](mdc:.i3/{{feature}}/ideation.txt) to fully understand the defined problem, requirements, goals, and scope boundaries. This is your immutable contract.
...
**C. Working with [instruction.md](mdc:.i3/{{feature}}/instruction.txt):**
...
*   **Goal**: Produce a coherent [instruction.md](mdc:.i3/{{feature}}/instruction.txt) file that provides a clear technical roadmap for implementation.
...
*   **Completion**: When you and the stakeholder agree that [instruction.md](mdc:.i3/{{feature}}/instruction.txt) provides a clear, complete technical roadmap for implementation, notify them that the Instruction artifact is ready for final review.

**E. Implementation File Preparation:**

*   **Prepare implementation.json Framework**: After finalizing [instruction.md](mdc:.i3/{{feature}}/instruction.txt), you should create or update [implementation.json](mdc:.i3/{{feature}}/implementation.json) with:
